...
<body class="pb-20 md:pb-0"> <!-- Padding bottom for mobile -->

    <!-- Header -->
    <header class="bg-blue-900 text-white shadow-md md:rounded-b-none rounded-b-3xl">
        <div class="max-w-6xl mx-auto p-6">
            <div class="flex justify-between items-start md:items-center mb-6 flex-col md:flex-row gap-4">
                <div>
                    <h1 class="text-2xl font-bold">Olá, <span id="user-name">Paciente</span>!</h1>
                    <p class="text-blue-200 text-sm md:text-base mt-1">Sua recuperação está indo muito bem.</p>
                </div>
                <button id="logout-btn" class="flex items-center text-blue-200 hover:text-white transition-colors bg-blue-800/50 hover:bg-blue-800 px-4 py-2 rounded-lg" aria-label="Sair">
            ...
            <!-- Progress Bar -->
            <div class="bg-white/10 rounded-xl p-5 backdrop-blur-sm shadow-sm border border-white/5">
                <div class="flex justify-between text-sm md:text-base mb-3">
                ...
                <div class="w-full bg-blue-950 rounded-full h-3">
                    <div class="bg-green-500 h-3 rounded-full transition-all duration-1000" style="width: 26.6%"></div>
                </div>
            </div>
        </div>
    </header>
    ...
    <main class="p-4 max-w-6xl mx-auto mt-2 md:mt-6">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div class="md:col-span-7 lg:col-span-8 space-y-6">
                <section>
                    ...
                    <div class="grid grid-cols-1 xl:grid-cols-2 gap-4">
                        <!-- Task 1 -->
                        <div class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 flex justify-between items-center transition-all duration-300 hover:shadow-md" id="task-1-card">
                            <div class="flex items-center space-x-4">
                                <div class="w-12 h-12 rounded-full bg-blue-50 flex items-center justify-center text-blue-600 flex-shrink-0" id="task-1-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z" />
                                    </svg>
                                </div>
                                <div>
                                    <p class="font-semibold text-gray-800 text-lg" id="task-1-title">Trocar Curativo</p>
                        ...
                        <!-- Task 2 -->
                        <div class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 flex justify-between items-center transition-all duration-300 hover:shadow-md" id="task-2-card">
                            <div class="flex items-center space-x-4">
                                <div class="w-12 h-12 rounded-full bg-blue-50 flex items-center justify-center text-blue-600 flex-shrink-0" id="task-2-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                                    </svg>
                                </div>
                                <div>
                                    <p class="font-semibold text-gray-800 text-lg" id="task-2-title">Caminhada Leve</p>
            ...
            <div class="md:col-span-5 lg:col-span-4 space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        <div class="p-5 border-b border-gray-50 flex justify-between items-center">
                            ...
                            <div class="flex flex-col items-end gap-1">
                                <span class="inline-block bg-blue-100 text-blue-800 text-xs px-2.5 py-1 rounded-full font-bold">08:00</span>
                                <span class="inline-block bg-blue-50 text-blue-600 text-xs px-2.5 py-1 rounded-full font-semibold">20:00</span>
                            </div>
                        </div>
                        <div class="bg-gray-50 p-4 flex flex-col sm:flex-row gap-3">
                            <button class="flex-1 bg-green-500 hover:bg-green-600 text-white py-2.5 rounded-xl text-sm font-bold transition-colors flex justify-center items-center shadow-sm" onclick="confirmMeds(this)">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                </svg>
                                Tomei as 08:00
                            </button>
                            <button class="flex-1 bg-white border-2 border-blue-100 text-blue-800 hover:bg-blue-50 py-2.5 rounded-xl text-sm font-bold transition-colors shadow-sm">
                                Próximo: 20:00
                            </button>
                        </div>
                    </div>
                ...
                <section>
                    <div class="bg-gradient-to-br from-red-50 to-white rounded-2xl p-6 border border-red-100 shadow-sm relative overflow-hidden h-full">
                        <div class="absolute top-0 right-0 p-4 opacity-5 text-red-600 transform translate-x-4 -translate-y-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-32 w-32" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                            </svg>
                        </div>
                        <h2 class="text-xl font-bold text-red-800 mb-2 flex items-center relative z-10">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                            </svg>
                            Sinais de Alerta
                        ...
                        <a href="tel:0800123456" class="mt-6 block w-full bg-red-600 hover:bg-red-700 text-white text-center font-bold py-3.5 rounded-xl transition-colors shadow-md hover:shadow-lg relative z-10 flex items-center justify-center text-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
